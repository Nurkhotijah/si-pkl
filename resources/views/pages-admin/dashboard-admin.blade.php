...
<body class="flex-1 p-6 bg-gray-100 font-poppins">
  ...
  <div class="grid grid-cols-1  lg:grid-cols-3 gap-4">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 text-center border border-transparent hover:border-gradient-to-r hover:from-red-400 hover:to-red-600 transition" style="width: 100%; max-width: 400px; margin: auto;">
    ...
    var kehadiranChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [{{ $jumlahHadir }}, {{ $jumlahIzin }}, {{ $jumlahTidakHadir }}],
