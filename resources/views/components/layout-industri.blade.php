        ...
        <div class="flex-1 flex flex-col overflow-auto">
            <nav
                ...
                <div class="flex items-center space-x-6 ml-auto">
                    ...
                    $notifications = Notification::where('created_at', '>=', now()->subHours(24))->latest()->get();
                @endphp

<div class="relative ml-auto">
    <!-- Tombol Notifikasi -->
    <button id="notification-btn" class="text-gray-700 rounded-md relative">
        ...
        @if($notifications->count() > 0)
            <span class="absolute top-0 right-0 inline-block w-4 h-4 bg-red-500 text-white text-xs font-bold rounded-full flex items-center justify-center">
                {{ $notifications->count() }}
            </span>
        @endif
    </button>
    ...
    <!-- Dropdown Notifikasi -->
    <div id="notification-dropdown" class="hidden absolute right-0 mt-2 w-56 bg-white border rounded-lg shadow-lg">
        <ul class="p-2 text-gray-700">
            ...
            @if($notifications->count() == 0)
                <li class="p-2 text-center text-gray-500">Tidak ada notifikasi</li>
            @endif
        </ul>
    </div>
</div>
