...
<body class="font-roboto">
  ...
  <header class="bg-gradient-to-r from-teal-500 to-blue-500 p-4 flex justify-between items-center sticky-header">
    ...
    <nav class="hidden md:flex space-x-4">
        ...
        <a href="#kontak" class="text-white hover:text-yellow-400">Kontak</a>
    ...
    <div class="max-w-4xl mx-auto py-16 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div class="flex items-start mb-8">
                <img src="{{ asset('assets/location.png') }}" alt="email" class="w-8 h-8 mr-4">
              <div>
                <h2 class="text-xl font-semibold mb-2">Alamat</h2>
                <p class="text-gray-700">Ruko Pakuan Regency, Jl. Amparan Jati Blok A2 No 11, RT.01/RW.07, Margajaya, Kec. Bogor Bar., Kota Bogor, Jawa Barat 16116</p>
              </div>
            </div>
